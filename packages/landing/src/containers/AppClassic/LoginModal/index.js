...
import LoginImage from 'common/assets/image/appClassic/loginBackground.webp';
import GoogleLogo from 'common/assets/image/appClassic/google-icon.jpg';
		...
		<LoginModalWrapper>
			<Box className="row" {...row}>
				...
				<Box className="col tabCol" {...col}>
					<Box {...contentWrapper}>
						<Image src={LogoImage?.src} {...logoStyle} style={{"width":"220px"}} alt="Logo" />
						<Tabs
						...
						>
							<TabPane tab="LOGIN" key="loginForm">
								<Heading content="Welcome" {...titleStyle} />
								<Text
									content="Welcome to Orienteering.pro Family. Please login with your personal account."
									{...descriptionStyle}
								/>
								<Button
							...
							<TabPane tab="REGISTER" key="registerForm">
								<Heading content="Welcome" {...titleStyle} />
								<Text
									content="Welcome to Orienteering.pro Family. Please register your personal account."
									{...descriptionStyle}
								/>
								<Button
									icon={<Image src={GoogleLogo?.src} alt="Google Icon" />}
