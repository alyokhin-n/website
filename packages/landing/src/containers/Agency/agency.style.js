...
const GlobalStyle = createGlobalStyle`
      ...
      .scrollspy__menu {
        ...
        li {
          ...
          a {
            ...
            transition: all 0.3s ease;
            &:hover {
              color: ${themeGet('colors.primary', '#FF6004')};
            }
          }
          &.is-current {
            a {
              ...
              &:before {
                ...
                height: 8px;
                border-radius: 50%;
                background-color: ${themeGet('colors.primary', '#FF6004')};
                position: absolute;
                top: calc(50% - 8px / 2);
                left: -20px;
              }
  ...
  button.modalCloseBtn {
    ...
    &.alt {
      background-color: ${themeGet('colors.primary', '#FF6004')} !important;
      box-shadow: 0 8px 38px #bb5114 !important;
    }
  }
  .reuseModalHolder {
    border: 0 !important;
